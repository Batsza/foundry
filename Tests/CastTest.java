...
class CastTest {
    ...
    void isQuality() {
        Cast cast1 = new Cast(1,"ok",13,"true",1,1,1);
        assertEquals("true", cast1.getQuality());
    ...
    void setQuality() {
        Cast cast1 = new Cast(1,"ok",13,"true",1,1,1);
        assertEquals("false", cast1.getQuality());
    }
    ...
    void getIdProj() {
        Cast cast1 = new Cast(1,"ok",13,"true",1,1,1);
        assertEquals(1, cast1.getIdProject());
    }

    @Test
    void setIdProj() {
        Cast cast1 = new Cast(1,"ok",13,"true",1,1,1);
        cast1.setIdProject(2);
        assertEquals(2, cast1.getIdProject());
    }
